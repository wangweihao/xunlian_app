...
public class XlServer {
    ...
    public XlServer(String ip, int port){
        serverIp = ip;
        serverPort = port;
        dbPool = new DatabasePool("rv27st52b707t671", "w13659218813", "rds1l1z1ubg1x0w81y40.mysql.rds.aliyuncs.com", "XL_db");
    ...
    public static void main(String[] args) throws Exception {
        XlServer server = new XlServer("192.168.20.227", 10000);
        server.run();
    }
}
